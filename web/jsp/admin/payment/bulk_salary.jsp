...
<head>
    ...
    <title>Bulk Salary Payment - Banking App</title>
...
<body>
    ...
    <div class="container">
        ...
        <div class="info-box">
            <strong>Bulk Salary Payment:</strong> This feature allows you to process salary payments for all active employees in a single batch. 
            The system will calculate the total amount and create a batch record for approval before processing.
        </div>
        
        <form method="POST" action="${pageContext.request.contextPath}/payment" onsubmit="return validateForm();">
            <input type="hidden" name="action" value="process_bulk_salary">
            
            <div class="form-group">
                <label for="batchName">Batch Name:</label>
                <input type="text" id="batchName" name="batchName" required placeholder="e.g., January 2026 Salary">
                <small>A descriptive name for this salary payment batch</small>
            </div>
            
            <div class="form-group">
                <label for="paymentDate">Payment Date:</label>
                <input type="date" id="paymentDate" name="paymentDate" required>
                <small>The date when these salaries will be paid</small>
            </div>
    ...
    <script>
        function validateForm() {
            ...
            if (!confirm("Are you sure you want to create this salary payment batch?\n\nThis will process payments for all active employees.")) {
                return false;
            }
