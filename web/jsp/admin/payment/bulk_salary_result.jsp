...
<head>
    ...
    <title>Bulk Salary Payment Result - Banking App</title>
    ...
    <div class="container">
        <c:if test="${not empty success}">
            <div class="result-box success">
                <h2>✓ Bulk Salary Payment Batch Created Successfully</h2>
                <p>${success}</p>
                ...
                <div class="summary">
                    ...
                    <div class="summary-item">
                        ...
                        <span>The batch has been created. Please review and approve it before processing payments.</span>
                    </div>
                </div>
        ...
        <c:if test="${not empty error}">
            <div class="result-box error">
                <h2>✗ Error Creating Salary Payment Batch</h2>
                <p>${error}</p>
                
                <div class="buttons">
                    <a href="${pageContext.request.contextPath}/payment?action=bulk_salary" class="btn-primary">Try Again</a>
